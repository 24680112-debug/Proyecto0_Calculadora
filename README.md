...
# 2.La Estructura de Rejilla (Columnas y Filas)
```
@ft.control
...
# 3.El sistema de toma de decisiones (Flujo Lógico)
```
...
# Resultado en flet
<img width="377" height="328" alt="image" src="https://github.com/user-attachments/assets/46d3166d-22df-4ed3-8ce8-0914b5a85ae6" />
